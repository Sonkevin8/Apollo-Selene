...
const Events = ({ theme, siteContent = {}, onSiteContentUpdated }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('clerk:loaded', syncAdmin);
    window.addEventListener('clerk:session-updated', syncAdmin);
    document.addEventListener('visibilitychange', onVisibilityChange);
    return () => {
      window.removeEventListener(ADMIN_CHANGED_EVENT, syncAdmin);
      window.removeEventListener('storage', syncAdmin);
      window.removeEventListener('focus', syncAdmin);
      window.removeEventListener('clerk:loaded', syncAdmin);
      window.removeEventListener('clerk:session-updated', syncAdmin);
